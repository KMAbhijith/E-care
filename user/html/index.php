            ...
            <div class="owl-carousel wow fadeInUp" id="doctorSlideshow">
                <div class="item">
                    <div class="card-doctor">
                        <div class="header">
                            <img src="../assets/img/department/cardiology.png" alt="">
                            <div class="meta">
                            </div>
                        </div>
                        <div class="body">
                            <p class="text-xl mb-0">Cardiology</p>
                            <span class="text-sm text-grey"><a href="#"
                                    style="text-decoration:none">Check-now</a></span>
                        </div>
                    </div>
                </div>
